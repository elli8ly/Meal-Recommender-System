...
```{r}
# /Users/jim-leewu/Desktop/classes/PSTAT 134/Final/PSTAT 134 Final/recipes.csv
# ~/Downloads/recipes.csv
#/Users/du/Documents/UCSB/PSTAT 134/Final Project/recipes.csv
recipes <- read.csv("/Users/elliotly/Desktop/recipes.csv")
head(recipes)
```
...
Analysis: In Example 2, the system was tested with a 21-year-old female weighing 105 lbs, 61 inches tall, with an activity level of 4 and a goal of muscle gain.